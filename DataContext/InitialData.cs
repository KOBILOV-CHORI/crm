    ...
    internal class Data
    {
        ...
        public static readonly IEnumerable<Task> Tasks = new List<Task>
        {
            new Task
            {
                ...
                StartDate = new DateTime(2024, 1, 1), EndDate = new DateTime(2023, 1, 10),
                Status = TaskStatus.InProgress, ProjectId = 1, AssignedToId = 6, CreatedAt = new DateTime(2023, 09, 10)
            },
            new Task
            {
